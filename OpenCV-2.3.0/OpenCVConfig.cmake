...
SET(OpenCV_INCLUDE_DIRS "/home/Tiandao/workspace/opencv/OpenCV-2.3.0" "/home/Tiandao/workspace/opencv/OpenCV-2.3.0/include" "/home/Tiandao/workspace/opencv/OpenCV-2.3.0/include/opencv")
...
SET(OpenCV_LIB_DIR /home/Tiandao/workspace/opencv/OpenCV-2.3.0/lib)
...
# ==============================================================
if(NOT "/home/Tiandao/workspace/opencv/OpenCV-2.3.0" STREQUAL  "")
    SET(BASEDIR "/home/Tiandao/workspace/opencv/OpenCV-2.3.0")
    foreach(__CVLIB ${OPENCV_LIB_COMPONENTS})
    ...
    endforeach(__CVLIB)
endif(NOT "/home/Tiandao/workspace/opencv/OpenCV-2.3.0" STREQUAL  "")
...
IF (NOT OpenCV_SHARED)
    ...
    if(WIN32 AND NOT ANDROID)
        LINK_DIRECTORIES("/home/Tiandao/workspace/opencv/OpenCV-2.3.0"/3rdparty/lib)
    else()
        LINK_DIRECTORIES("${THIS_OPENCV_CONFIG_PATH}/3rdparty/lib")
    endif()    

    set(OpenCV_LIBS dl;m;pthread;rt  gtk-x11-2.0;gdk-x11-2.0;atk-1.0;gio-2.0;pangoft2-1.0;pangocairo-1.0;gdk_pixbuf-2.0;m;cairo;png12;pango-1.0;freetype;fontconfig;gobject-2.0;gmodule-2.0;gthread-2.0;rt;glib-2.0;gthread-2.0;rt;glib-2.0;gstbase-0.10;gstreamer-0.10;gobject-2.0;gmodule-2.0;xml2;gthread-2.0;rt;glib-2.0;gstapp-0.10;gstbase-0.10;gstreamer-0.10;gobject-2.0;gmodule-2.0;xml2;gthread-2.0;rt;glib-2.0;gstvideo-0.10;gstbase-0.10;gstreamer-0.10;gobject-2.0;gmodule-2.0;xml2;gthread-2.0;rt;glib-2.0 ${OpenCV_LIBS})

    set(OPENCV_EXTRA_COMPONENTS /usr/lib/libjpeg.so /usr/lib/libpng.so;/usr/lib/libz.so /usr/lib/libtiff.so libjasper zlib)
